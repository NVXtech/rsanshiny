...
agua_esgoto_ui <- function(id){
  ...
  fluidPage(
    fluidRow(
    column(4, h3("Módulo Demográfico"),titlePanel("Dados de Entrada"),
           selectInput(
             inputId = ns("snis"),
    ...
    column(4, h3("Módulo Orçamentário"),titlePanel("Dados de Entrada"),
           selectInput(
             inputId = ns("sinapi"),
    ...
    fluidRow(actionButton(ns("rodar"), label = "Recalcular"))
  )
}
